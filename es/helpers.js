...
function cloner(deep, item) {
  if (!item || typeof item !== 'object' || item instanceof Error || item instanceof MonkeyDefinition || item instanceof Monkey || 'ArrayBuffer' in global && item instanceof ArrayBuffer) return item;
